...
export const ADMIN_MODULES: AdminModule[] = [
  ...
  { key: 'finance', name: 'Anubis ID Ledger', href: '/anubis-ledger' },
  ...
  { key: 'game_control', name: 'Crash Operations', href: '/crash-operations' },
  { key: 'game_history', name: 'Game History', href: '/game-history' },
  { key: 'gifts', name: 'Gifts Catalog', href: '/gifts' },
  { key: 'gifts', name: 'Self-Gift Monitoring', href: '/self-gifts' },
  ...
  { key: 'analytics', name: 'Host Live Time', href: '/host-live-time' },
